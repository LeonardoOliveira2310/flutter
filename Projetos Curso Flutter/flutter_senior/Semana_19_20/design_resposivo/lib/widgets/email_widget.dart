...
import 'package:design_resposivo/widgets/star_button.dart';
          ...
          LayoutBuilder(
            builder: (context, constrainsts) {
              return Row(
                ...
                children: [
                  if (constrainsts.maxWidth - 200 > 0) ...[
                    CircleAvatar(
                  ...
                  if (constrainsts.maxWidth - 200 > 0) ...[const StarButton()],
                ],
              );
            },
          ),
